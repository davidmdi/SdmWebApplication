...
public class StaticOrderSummeryServlet extends HttpServlet {
    ...
    private String buildOrderSemmeryForm(Order staticOrderFromJs, HttpServletRequest req) throws ParseException {
       ...
       Map<Integer, MyStoreSingleOrderItems> storeSingleOrderItemsMap = ServletUtils.createSingleOrderItemsMap(order,req , engine);
        ...
        synchronized (this) {
            SessionUtils.saveOrderDataOnSession(order,storeSingleOrderItemsMap,req);
        }

        return ServletUtils.buildHtmlFormForOrrderSummery(order,storeSingleOrderItemsMap,engine,req);
    }
...
//    private String buildHtmlFormForOrrderSummery(MyOrder order, Map<Integer
